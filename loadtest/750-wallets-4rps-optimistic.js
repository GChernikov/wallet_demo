// Scenario A — Optimistic Locking, low contention
// 750 wallets × 4 RPS = 3000 RPS total
// Run: make seed first to generate wallets-ol-750.json
import http from 'k6/http';
import { check } from 'k6';
import { Counter } from 'k6/metrics';
import { SharedArray } from 'k6/data';

const wallets = new SharedArray('wallets', () => JSON.parse(open('./wallets-ol-750.json')));
